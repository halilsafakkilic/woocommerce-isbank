 ...
 * Version:     1.0.0
 * Author:      Adil Öztaşer, Halil Şafak KILIÇ
 * License:     GPLv2
 */
...
if (!class_exists('WC_Isbank')) {
    class WC_Isbank
    {
        ...
        {
            add_filter('woocommerce_payment_gateways', [$this, 'add_isbank_gateway']);
        ...
        {
            add_action('wp_ajax_validate_isbank_form', ['WC_Isbank_Gateway_Form', 'validate_fields']);
            add_action('wp_ajax_nopriv_validate_isbank_form', ['WC_Isbank_Gateway_Form', 'validate_fields']);
        }
    ...
    WC_Isbank::instance();
    register_activation_hook(__FILE__, ['WC_Isbank', 'activation']);
}